    ...
    <section className="w-full">
      ...
      <div className="flex flex-col md:flex-row w-full mb-20">
        <div className="md:w-1/2 h-1/2 md:h-auto p-12">
          <img src='https://images.groovetech.io/zTfYT0TZ1vI8Pc-V5FuZCkiEyMVNsFuarsrET_t9tjY/rs:fit:0:0:0/g:no:0:0/c:0:0/aHR0cHM6Ly9hc3NldHMuZ3Jvb3ZlYXBwcy5jb20vaW1hZ2VzLzVmMDMxZDFhYTg2NGNlMDAxOTA5ZGJjMC8xNjA3Mzk4MTM5XzEwMzU2MzMwOF82OTEyMTM0NTgxMTQ0NzJfNDE3NTM4MDc2MTU0Mzg0OTY2NF9vLmpwZw.webp' alt="About Us" className="object-cover w-full h-full" />
        </div>
